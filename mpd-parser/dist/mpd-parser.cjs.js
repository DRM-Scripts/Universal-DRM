...
var organizeAudioPlaylists = function organizeAudioPlaylists(playlists, sidxMapping) {
  ...
  var formattedPlaylists = playlists.reduce(function (a, playlist) {
    ...
    if (language) {
      ...
      label = "" + playlist.attributes.lang + roleLabel + playlist.attributes.codecs;
...
var toM3u8 = function toM3u8(dashPlaylists, sidxMapping) {
  ...
  var master = {
    ...
    attributes: dashPlaylists[0].attributes
  };
...
function decodeB64ToUint8Array(b64Text) {
  ...
  var decodedString =  Buffer.from(b64Text, 'base64').toString('ascii');
...
var generateKeySystemInformation = function generateKeySystemInformation(contentProtectionNodes) {
  return contentProtectionNodes.reduce(function (acc, node) {
    ...
    var keySystem = keySystemsMap[attributes.schemeIdUri.toLowerCase()];

    if (keySystem) {
      acc[keySystem] = {
        attributes: attributes
      };
      var psshNode = findChildren(node, 'cenc:pssh')[0] || findChildren(node, 'pssh')[0];
      if (psshNode) {
...
var toRepresentations = function toRepresentations(periodAttributes, periodBaseUrls, periodSegmentInfo) {
  return function (adaptationSet) {
    ...
    var contentProtection = generateKeySystemInformation(children);
...
var b64Parse = function b64Parse(b64String, options) {
